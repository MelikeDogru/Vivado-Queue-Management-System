...
HD_PWD='C:/Users/life/project_1/project_1.runs/design_main_project_xlconcat_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_main_project_xlconcat_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_main_project_xlconcat_0_3.tcl

...
HD_PWD='C:/Users/life/project_1/project_1.runs/design_main_project_seg7display_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_main_project_seg7display_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_main_project_seg7display_0_0.tcl

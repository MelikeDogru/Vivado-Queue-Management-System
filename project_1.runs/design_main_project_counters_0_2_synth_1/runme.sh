...
HD_PWD='C:/Users/life/project_1/project_1.runs/design_main_project_counters_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_main_project_counters_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_main_project_counters_0_2.tcl

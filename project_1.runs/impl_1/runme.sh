...
HD_PWD='C:/Users/life/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_main_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_main_project_wrapper.tcl -notrace
